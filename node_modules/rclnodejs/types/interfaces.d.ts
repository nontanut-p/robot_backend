...
declare module 'rclnodejs' {
  ...
  namespace agribot_interfaces {
    namespace msg {
      export interface CmdMotors {
        stamp: builtin_interfaces.msg.Time;
        motor_ids: number[] | Uint8Array;
        positions: number[] | Float64Array;
      }
      export interface CmdMotorsConstructor {
        new(other?: CmdMotors): CmdMotors;
      }
      export interface CmdSprays {
        on: boolean[];
      }
      export interface CmdSpraysConstructor {
        new(other?: CmdSprays): CmdSprays;
      }
      ...
      export interface GyroConstructor {
        new(other?: Gyro): Gyro;
      }
      export interface Lane {
        stamp: builtin_interfaces.msg.Time;
        p1: geometry_msgs.msg.Pose2D;
        p2: geometry_msgs.msg.Pose2D;
      }
      export interface LaneConstructor {
        new(other?: Lane): Lane;
      }
      ...
      export interface MotorStatusConstructor {
        new(other?: MotorStatus): MotorStatus;
      }
      ...
      export interface OdomConstructor {
        new(other?: Odom): Odom;
      }
      export interface Pose2DStamped {
        stamp: builtin_interfaces.msg.Time;
        pose: geometry_msgs.msg.Pose2D;
        twist: geometry_msgs.msg.Pose2D;
      }
      ...
      export interface RobotStatus {
        ...
        remote_on: boolean;
        control_mode: string;
        motors: agribot_interfaces.msg.MotorStatus[];
      }
      export interface RobotStatusConstructor {
        new(other?: RobotStatus): RobotStatus;
      }
    }
    namespace srv {
      export interface ControlModeConstructor extends ROSService {
        readonly Request: ControlMode_RequestConstructor;
        readonly Response: ControlMode_ResponseConstructor;
      }
      export interface ControlMode_Request {
        control_mode: string;
      }
      export interface ControlMode_RequestConstructor {
        new(other?: ControlMode_Request): ControlMode_Request;
      }
      export interface ControlMode_Response {
      }
      export interface ControlMode_ResponseConstructor {
        new(other?: ControlMode_Response): ControlMode_Response;
      }
      export interface DriverCMDConstructor extends ROSService {
        readonly Request: DriverCMD_RequestConstructor;
        readonly Response: DriverCMD_ResponseConstructor;
      }
      export interface DriverCMD_Request {
        cmd: string;
      }
      export interface DriverCMD_RequestConstructor {
        new(other?: DriverCMD_Request): DriverCMD_Request;
      }
      export interface DriverCMD_Response {
      }
      export interface DriverCMD_ResponseConstructor {
        new(other?: DriverCMD_Response): DriverCMD_Response;
      }
      export interface EnableSprayConstructor extends ROSService {
        readonly Request: EnableSpray_RequestConstructor;
        readonly Response: EnableSpray_ResponseConstructor;
      }
      export interface EnableSpray_Request {
        enable: boolean;
      }
      export interface EnableSpray_RequestConstructor {
        new(other?: EnableSpray_Request): EnableSpray_Request;
      }
      export interface EnableSpray_Response {
      }
      export interface EnableSpray_ResponseConstructor {
        new(other?: EnableSpray_Response): EnableSpray_Response;
      }
      export interface GetPathConstructor extends ROSService {
        readonly Request: GetPath_RequestConstructor;
        readonly Response: GetPath_ResponseConstructor;
      }
      export interface GetPathListConstructor extends ROSService {
        readonly Request: GetPathList_RequestConstructor;
        readonly Response: GetPathList_ResponseConstructor;
      }
      export interface GetPathList_Request {
      }
      export interface GetPathList_RequestConstructor {
        new(other?: GetPathList_Request): GetPathList_Request;
      }
      export interface GetPathList_Response {
        result: number;
        file_path: string[];
        name: string[];
        created_time: number[];
        distance: number[] | Float64Array;
      }
      export interface GetPathList_ResponseConstructor {
        new(other?: GetPathList_Response): GetPathList_Response;
      }
      export interface GetPathStatusConstructor extends ROSService {
        readonly Request: GetPathStatus_RequestConstructor;
        readonly Response: GetPathStatus_ResponseConstructor;
      }
      export interface GetPathStatus_Request {
      }
      export interface GetPathStatus_RequestConstructor {
        new(other?: GetPathStatus_Request): GetPathStatus_Request;
      }
      export interface GetPathStatus_Response {
        status: string;
        path_name: string;
        path_file: string;
      }
      export interface GetPathStatus_ResponseConstructor {
        new(other?: GetPathStatus_Response): GetPathStatus_Response;
      }
      export interface GetPath_Request {
        name: string;
      }
      export interface GetPath_RequestConstructor {
        new(other?: GetPath_Request): GetPath_Request;
      }
      export interface GetPath_Response {
        result: number;
        file_path: string;
      }
      export interface GetPath_ResponseConstructor {
        new(other?: GetPath_Response): GetPath_Response;
      }
      export interface OptimizePathConstructor extends ROSService {
        readonly Request: OptimizePath_RequestConstructor;
        readonly Response: OptimizePath_ResponseConstructor;
      }
      export interface OptimizePath_Request {
        name: string;
      }
      export interface OptimizePath_RequestConstructor {
        new(other?: OptimizePath_Request): OptimizePath_Request;
      }
      export interface OptimizePath_Response {
        result: number;
      }
      export interface OptimizePath_ResponseConstructor {
        new(other?: OptimizePath_Response): OptimizePath_Response;
      }
      export interface SetHeadingConstructor extends ROSService {
        readonly Request: SetHeading_RequestConstructor;
        readonly Response: SetHeading_ResponseConstructor;
      }
      export interface SetHeading_Request {
        theta: number;
      }
      export interface SetHeading_RequestConstructor {
        new(other?: SetHeading_Request): SetHeading_Request;
      }
      export interface SetHeading_Response {
        result: number;
      }
      export interface SetHeading_ResponseConstructor {
        new(other?: SetHeading_Response): SetHeading_Response;
      }
      export interface StartFollowPathConstructor extends ROSService {
        readonly Request: StartFollowPath_RequestConstructor;
        readonly Response: StartFollowPath_ResponseConstructor;
      }
      export interface StartFollowPath_Request {
        name: string;
      }
      export interface StartFollowPath_RequestConstructor {
        new(other?: StartFollowPath_Request): StartFollowPath_Request;
      }
      export interface StartFollowPath_Response {
        result: number;
      }
      export interface StartFollowPath_ResponseConstructor {
        new(other?: StartFollowPath_Response): StartFollowPath_Response;
      }
      export interface StartRecordPathConstructor extends ROSService {
        readonly Request: StartRecordPath_RequestConstructor;
        readonly Response: StartRecordPath_ResponseConstructor;
      }
      export interface StartRecordPath_Request {
        name: string;
      }
      export interface StartRecordPath_RequestConstructor {
        new(other?: StartRecordPath_Request): StartRecordPath_Request;
      }
      export interface StartRecordPath_Response {
        result: number;
      }
      export interface StartRecordPath_ResponseConstructor {
        new(other?: StartRecordPath_Response): StartRecordPath_Response;
      }
      ...
      export interface StopFollowPathConstructor extends ROSService {
        readonly Request: StopFollowPath_RequestConstructor;
        readonly Response: StopFollowPath_ResponseConstructor;
      }
      export interface StopFollowPath_Request {
      }
      export interface StopFollowPath_RequestConstructor {
        new(other?: StopFollowPath_Request): StopFollowPath_Request;
      }
      export interface StopFollowPath_Response {
        result: number;
      }
      export interface StopFollowPath_ResponseConstructor {
        new(other?: StopFollowPath_Response): StopFollowPath_Response;
      }
      export interface StopRecordPathConstructor extends ROSService {
        readonly Request: StopRecordPath_RequestConstructor;
        readonly Response: StopRecordPath_ResponseConstructor;
      }
      export interface StopRecordPath_Request {
      }
      export interface StopRecordPath_RequestConstructor {
        new(other?: StopRecordPath_Request): StopRecordPath_Request;
      }
      export interface StopRecordPath_Response {
        result: number;
      }
      export interface StopRecordPath_ResponseConstructor {
        new(other?: StopRecordPath_Response): StopRecordPath_Response;
      }
      ...
      export interface TestCalVeloConstructor extends ROSService {
        readonly Request: TestCalVelo_RequestConstructor;
        readonly Response: TestCalVelo_ResponseConstructor;
      }
      export interface TestCalVelo_Request {
        vx: number;
        vy: number;
        w: number;
      }
      export interface TestCalVelo_RequestConstructor {
        new(other?: TestCalVelo_Request): TestCalVelo_Request;
      }
      export interface TestCalVelo_Response {
      }
      export interface TestCalVelo_ResponseConstructor {
        new(other?: TestCalVelo_Response): TestCalVelo_Response;
      }
    }
  }
  ...
  namespace gps_pubsub {
    namespace msg {
      export interface Mymessage {
        lon: number;
        lat: number;
      }
      export interface MymessageConstructor {
        new(other?: Mymessage): Mymessage;
      }
    }
  }
  ...
  namespace tutorial_interfaces {
    ...
    namespace srv {
      export interface GNSSMessageConstructor extends ROSService {
        readonly Request: GNSSMessage_RequestConstructor;
        readonly Response: GNSSMessage_ResponseConstructor;
      }
      export interface GNSSMessage_Request {
        lat: number;
        lon: number;
        alt: number;
        velo: number;
      }
      export interface GNSSMessage_RequestConstructor {
        new(other?: GNSSMessage_Request): GNSSMessage_Request;
      }
      export interface GNSSMessage_Response {
        x: number;
        y: number;
        dis: number;
      }
      export interface GNSSMessage_ResponseConstructor {
        new(other?: GNSSMessage_Response): GNSSMessage_Response;
      }
    }
  }
  ...
  type MessagesMap = {
    ...
    'agribot_interfaces/msg/CmdMotors': agribot_interfaces.msg.CmdMotors,
    'agribot_interfaces/msg/CmdSprays': agribot_interfaces.msg.CmdSprays,
    'agribot_interfaces/msg/Gyro': agribot_interfaces.msg.Gyro,
    'agribot_interfaces/msg/Lane': agribot_interfaces.msg.Lane,
    'agribot_interfaces/msg/MotorStatus': agribot_interfaces.msg.MotorStatus,
    'agribot_interfaces/msg/Odom': agribot_interfaces.msg.Odom,
    'agribot_interfaces/msg/Pose2DStamped': agribot_interfaces.msg.Pose2DStamped,
    'agribot_interfaces/msg/RobotStatus': agribot_interfaces.msg.RobotStatus,
    'agribot_interfaces/srv/ControlMode_Request': agribot_interfaces.srv.ControlMode_Request,
    'agribot_interfaces/srv/ControlMode_Response': agribot_interfaces.srv.ControlMode_Response,
    'agribot_interfaces/srv/DriverCMD_Request': agribot_interfaces.srv.DriverCMD_Request,
    'agribot_interfaces/srv/DriverCMD_Response': agribot_interfaces.srv.DriverCMD_Response,
    'agribot_interfaces/srv/EnableSpray_Request': agribot_interfaces.srv.EnableSpray_Request,
    'agribot_interfaces/srv/EnableSpray_Response': agribot_interfaces.srv.EnableSpray_Response,
    'agribot_interfaces/srv/GetPathList_Request': agribot_interfaces.srv.GetPathList_Request,
    'agribot_interfaces/srv/GetPathList_Response': agribot_interfaces.srv.GetPathList_Response,
    'agribot_interfaces/srv/GetPathStatus_Request': agribot_interfaces.srv.GetPathStatus_Request,
    'agribot_interfaces/srv/GetPathStatus_Response': agribot_interfaces.srv.GetPathStatus_Response,
    'agribot_interfaces/srv/GetPath_Request': agribot_interfaces.srv.GetPath_Request,
    'agribot_interfaces/srv/GetPath_Response': agribot_interfaces.srv.GetPath_Response,
    'agribot_interfaces/srv/OptimizePath_Request': agribot_interfaces.srv.OptimizePath_Request,
    'agribot_interfaces/srv/OptimizePath_Response': agribot_interfaces.srv.OptimizePath_Response,
    'agribot_interfaces/srv/SetHeading_Request': agribot_interfaces.srv.SetHeading_Request,
    'agribot_interfaces/srv/SetHeading_Response': agribot_interfaces.srv.SetHeading_Response,
    'agribot_interfaces/srv/StartFollowPath_Request': agribot_interfaces.srv.StartFollowPath_Request,
    'agribot_interfaces/srv/StartFollowPath_Response': agribot_interfaces.srv.StartFollowPath_Response,
    'agribot_interfaces/srv/StartRecordPath_Request': agribot_interfaces.srv.StartRecordPath_Request,
    'agribot_interfaces/srv/StartRecordPath_Response': agribot_interfaces.srv.StartRecordPath_Response,
    'agribot_interfaces/srv/StopFollowPath_Request': agribot_interfaces.srv.StopFollowPath_Request,
    'agribot_interfaces/srv/StopFollowPath_Response': agribot_interfaces.srv.StopFollowPath_Response,
    'agribot_interfaces/srv/StopRecordPath_Request': agribot_interfaces.srv.StopRecordPath_Request,
    'agribot_interfaces/srv/StopRecordPath_Response': agribot_interfaces.srv.StopRecordPath_Response,
    'agribot_interfaces/srv/Stop_Request': agribot_interfaces.srv.Stop_Request,
    'agribot_interfaces/srv/Stop_Response': agribot_interfaces.srv.Stop_Response,
    'agribot_interfaces/srv/TestCalVelo_Request': agribot_interfaces.srv.TestCalVelo_Request,
    'agribot_interfaces/srv/TestCalVelo_Response': agribot_interfaces.srv.TestCalVelo_Response,
    ...
    'gps_pubsub/msg/Mymessage': gps_pubsub.msg.Mymessage,
    ...
    'realsense_camera_msgs/msg/Extrinsics': realsense_camera_msgs.msg.Extrinsics,
    'realsense_camera_msgs/msg/IMUInfo': realsense_camera_msgs.msg.IMUInfo,
    ...
    'tutorial_interfaces/msg/Num': tutorial_interfaces.msg.Num,
    'tutorial_interfaces/srv/GNSSMessage_Request': tutorial_interfaces.srv.GNSSMessage_Request,
    'tutorial_interfaces/srv/GNSSMessage_Response': tutorial_interfaces.srv.GNSSMessage_Response,
  ...
  type MessageTypeClassConstructorMap = {
    ...
    'agribot_interfaces/msg/CmdMotors': agribot_interfaces.msg.CmdMotorsConstructor,
    'agribot_interfaces/msg/CmdSprays': agribot_interfaces.msg.CmdSpraysConstructor,
    'agribot_interfaces/msg/Gyro': agribot_interfaces.msg.GyroConstructor,
    'agribot_interfaces/msg/Lane': agribot_interfaces.msg.LaneConstructor,
    'agribot_interfaces/msg/MotorStatus': agribot_interfaces.msg.MotorStatusConstructor,
    'agribot_interfaces/msg/Odom': agribot_interfaces.msg.OdomConstructor,
    'agribot_interfaces/msg/Pose2DStamped': agribot_interfaces.msg.Pose2DStampedConstructor,
    'agribot_interfaces/msg/RobotStatus': agribot_interfaces.msg.RobotStatusConstructor,
    'agribot_interfaces/srv/ControlMode_Request': agribot_interfaces.srv.ControlMode_RequestConstructor,
    'agribot_interfaces/srv/ControlMode_Response': agribot_interfaces.srv.ControlMode_ResponseConstructor,
    'agribot_interfaces/srv/DriverCMD_Request': agribot_interfaces.srv.DriverCMD_RequestConstructor,
    'agribot_interfaces/srv/DriverCMD_Response': agribot_interfaces.srv.DriverCMD_ResponseConstructor,
    'agribot_interfaces/srv/EnableSpray_Request': agribot_interfaces.srv.EnableSpray_RequestConstructor,
    'agribot_interfaces/srv/EnableSpray_Response': agribot_interfaces.srv.EnableSpray_ResponseConstructor,
    'agribot_interfaces/srv/GetPathList_Request': agribot_interfaces.srv.GetPathList_RequestConstructor,
    'agribot_interfaces/srv/GetPathList_Response': agribot_interfaces.srv.GetPathList_ResponseConstructor,
    'agribot_interfaces/srv/GetPathStatus_Request': agribot_interfaces.srv.GetPathStatus_RequestConstructor,
    'agribot_interfaces/srv/GetPathStatus_Response': agribot_interfaces.srv.GetPathStatus_ResponseConstructor,
    'agribot_interfaces/srv/GetPath_Request': agribot_interfaces.srv.GetPath_RequestConstructor,
    'agribot_interfaces/srv/GetPath_Response': agribot_interfaces.srv.GetPath_ResponseConstructor,
    'agribot_interfaces/srv/OptimizePath_Request': agribot_interfaces.srv.OptimizePath_RequestConstructor,
    'agribot_interfaces/srv/OptimizePath_Response': agribot_interfaces.srv.OptimizePath_ResponseConstructor,
    'agribot_interfaces/srv/SetHeading_Request': agribot_interfaces.srv.SetHeading_RequestConstructor,
    'agribot_interfaces/srv/SetHeading_Response': agribot_interfaces.srv.SetHeading_ResponseConstructor,
    'agribot_interfaces/srv/StartFollowPath_Request': agribot_interfaces.srv.StartFollowPath_RequestConstructor,
    'agribot_interfaces/srv/StartFollowPath_Response': agribot_interfaces.srv.StartFollowPath_ResponseConstructor,
    'agribot_interfaces/srv/StartRecordPath_Request': agribot_interfaces.srv.StartRecordPath_RequestConstructor,
    'agribot_interfaces/srv/StartRecordPath_Response': agribot_interfaces.srv.StartRecordPath_ResponseConstructor,
    'agribot_interfaces/srv/StopFollowPath_Request': agribot_interfaces.srv.StopFollowPath_RequestConstructor,
    'agribot_interfaces/srv/StopFollowPath_Response': agribot_interfaces.srv.StopFollowPath_ResponseConstructor,
    'agribot_interfaces/srv/StopRecordPath_Request': agribot_interfaces.srv.StopRecordPath_RequestConstructor,
    'agribot_interfaces/srv/StopRecordPath_Response': agribot_interfaces.srv.StopRecordPath_ResponseConstructor,
    'agribot_interfaces/srv/Stop_Request': agribot_interfaces.srv.Stop_RequestConstructor,
    'agribot_interfaces/srv/Stop_Response': agribot_interfaces.srv.Stop_ResponseConstructor,
    'agribot_interfaces/srv/TestCalVelo_Request': agribot_interfaces.srv.TestCalVelo_RequestConstructor,
    'agribot_interfaces/srv/TestCalVelo_Response': agribot_interfaces.srv.TestCalVelo_ResponseConstructor,
    ...
    'gps_pubsub/msg/Mymessage': gps_pubsub.msg.MymessageConstructor,
    ...
    'realsense_camera_msgs/msg/Extrinsics': realsense_camera_msgs.msg.ExtrinsicsConstructor,
    'realsense_camera_msgs/msg/IMUInfo': realsense_camera_msgs.msg.IMUInfoConstructor,
    ...
    'tutorial_interfaces/msg/Num': tutorial_interfaces.msg.NumConstructor,
    'tutorial_interfaces/srv/GNSSMessage_Request': tutorial_interfaces.srv.GNSSMessage_RequestConstructor,
    'tutorial_interfaces/srv/GNSSMessage_Response': tutorial_interfaces.srv.GNSSMessage_ResponseConstructor,
  ...
  type ServicesMap = {
    ...
    'agribot_interfaces/srv/ControlMode': agribot_interfaces.srv.ControlModeConstructor,
    'agribot_interfaces/srv/DriverCMD': agribot_interfaces.srv.DriverCMDConstructor,
    'agribot_interfaces/srv/EnableSpray': agribot_interfaces.srv.EnableSprayConstructor,
    'agribot_interfaces/srv/GetPath': agribot_interfaces.srv.GetPathConstructor,
    'agribot_interfaces/srv/GetPathList': agribot_interfaces.srv.GetPathListConstructor,
    'agribot_interfaces/srv/GetPathStatus': agribot_interfaces.srv.GetPathStatusConstructor,
    'agribot_interfaces/srv/OptimizePath': agribot_interfaces.srv.OptimizePathConstructor,
    'agribot_interfaces/srv/SetHeading': agribot_interfaces.srv.SetHeadingConstructor,
    'agribot_interfaces/srv/StartFollowPath': agribot_interfaces.srv.StartFollowPathConstructor,
    'agribot_interfaces/srv/StartRecordPath': agribot_interfaces.srv.StartRecordPathConstructor,
    'agribot_interfaces/srv/Stop': agribot_interfaces.srv.StopConstructor,
    'agribot_interfaces/srv/StopFollowPath': agribot_interfaces.srv.StopFollowPathConstructor,
    'agribot_interfaces/srv/StopRecordPath': agribot_interfaces.srv.StopRecordPathConstructor,
    'agribot_interfaces/srv/TestCalVelo': agribot_interfaces.srv.TestCalVeloConstructor,
    ...
    'tutorial_interfaces/srv/GNSSMessage': tutorial_interfaces.srv.GNSSMessageConstructor,
